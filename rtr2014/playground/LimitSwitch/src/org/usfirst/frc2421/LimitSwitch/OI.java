...
public class OI {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIO
    ...
    public OI() {
        ...
        button2.whenPressed(new ReleaseCatapult());
        // SmartDashboard Buttons
        SmartDashboard.putData("ReleaseCatapult", new ReleaseCatapult());
