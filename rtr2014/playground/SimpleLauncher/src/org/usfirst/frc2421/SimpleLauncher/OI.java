...
public class OI {
    ...
    public Joystick catapultControl;
    ...
    public OI() {
        ...
        SmartDashboard.putData("catapultFire", new catapultFire());
        SmartDashboard.putData("catapultReset", new catapultReset());
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    }
    
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=FUNCTIONS
    public Joystick getcatapultControl() {
        return catapultControl;
    }
