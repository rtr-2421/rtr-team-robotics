...
public class Drive extends Subsystem {
    ...
    Encoder leftQuadEncoder = RobotMap.driveleftQuadEncoder;
    Encoder rightQuadEncoder = RobotMap.driverightQuadEncoder;
    AnalogChannel distanceSensor = RobotMap.drivedistanceSensor;
