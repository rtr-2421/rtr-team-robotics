...
public class RobotMap {
    ...
    public static AnalogChannel driveleftlSpeed;
    public static AnalogChannel driverightSpeed;
    public static CANJaguar bigFireLeverMotorpowerMotor;
    public static CANJaguar bigFireLeverMotorpowerMotor2;
    public static AnalogChannel bigFireLeverMotorfireResetTest;
    ...
    public static AnalogChannel bigFireLeverPneumaticsfirePneumaticsResetTest;
    public static CANJaguar bigFireLeverSpringleverReset;
    public static AnalogChannel bigFireLeverSpringfireSpringResetTest;
    ...
    public static void init() {
        ...
        driveleftlSpeed = new AnalogChannel(1, 4);
	LiveWindow.addSensor("Drive", "leftlSpeed", driveleftlSpeed);
        
        driverightSpeed = new AnalogChannel(1, 5);
	LiveWindow.addSensor("Drive", "rightSpeed", driverightSpeed);
        ...
        bigFireLeverMotorfireResetTest = new AnalogChannel(1, 1);
	...
	LiveWindow.addActuator("BigFireLeverPneumatics", "engageDisengageFire", bigFireLeverPneumaticsengageDisengageFire);
        ...
        bigFireLeverPneumaticsfirePneumaticsResetTest = new AnalogChannel(1, 3);
	LiveWindow.addSensor("BigFireLeverPneumatics", "firePneumaticsResetTest", bigFireLeverPneumaticsfirePneumaticsResetTest);
        ...
        bigFireLeverSpringfireSpringResetTest = new AnalogChannel(1, 2);
	LiveWindow.addSensor("BigFireLeverSpring", "fireSpringResetTest", bigFireLeverSpringfireSpringResetTest);
